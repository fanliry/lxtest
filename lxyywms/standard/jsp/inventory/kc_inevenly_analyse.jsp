...
<!--
	...
	function Search(){
		...
		list.location.href = ac + "InAnalysisAction&flag=1" + condition;
	}
	function OnLoad(){
		//仓库
...
<div class="con_bk">
  <table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
    <tr><td>
	  ...
	  <!-- ======== 当前位置 ======== -->
	  <div class="wz">
		<div id="dqwz" class="f_l">当前位置：<span>库存管理 -&gt; 入库均匀分析</span></div>
    ...
    <tr><td>
      ...
      <table id="marginTable" width="99%"  border="0" cellpadding="0" cellspacing="0" class="table1" align="center"> 
	    <tr>
	      ...
	      <td><select name="warehouseid" onChange="getWhAreaList()" style="width:117px;"><option value=""></option></select></td>
	    </tr>
      </table> 
    ...
    <tr>
      <td valign="top" height="100%">
		...
		<table width="99%" height="100%" border="0" align="center" cellpadding="0" cellspacing="0">
		  <tr>
		    <td>
	          <iframe id="list" src="<%=request.getContextPath()%>/standard/jsp/inventory/kc_inevenly_analyse_list.jsp" 
