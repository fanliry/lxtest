...
<!--
	...
	function searchData(){
		...
		list.formx1.action = strUrl + "NeedCheckAction&flag=5" + condition;
    ...
    <tr>
      <td valign="top" height="100%">
		...
		<table width="99%" height="100%" border="0" align="center" cellpadding="0" cellspacing="0">
		  <tr>
		    <td>
	          <iframe id="list" src="<%=request.getContextPath()%>/standard/jsp/inventory/adjust/kc_outbound_exception_list.jsp" 
