...
<!--
	...
	function delData()
	{
		  ...
		  var id = document.getElementById("MMId").value;
		   if(deleteName == null||deleteName.length <1){
					...
					if(del){
						window.myIframe.location.href = "<%=request.getContextPath()%>/BMSService?actionCode=inventoryAdjustAction&method=ricoExecCheckDeleteDetail&id=" + id+"&deleteStr="+deleteName;		
					}
		    }
	}
	//获得选择的选择框的值
	...
	{
			var result = showModalDialog("<%=request.getContextPath()%>/standard/jsp/inventory/adjust/kc_adjust_check_search.jsp?wharehouseid="+"<%=wharehouseid%>",'','dialogWidth=800px;dialogHeight=600px');
		   	...
		   	if(result != null && result.length > 1)
		   	{
		   		...
		   		document.getElementById("checkresult").value = temStr[1]; //盘点结果
		   		document.getElementById("product").value = temStr[2];//产品名   
		   		...
		   		document.getElementById("checkid").value = temStr[10];//盘点结果单id
		   		
		   		document.getElementById("tonum").value = temStr[1];//目标数量
		   	}
	...
	{
		 var actionStr = "BMSService?actionCode=inventoryAdjustAction&method=ricoExecAddCheckDetail"
				 + "&id="+id
				 + "&inventoryid=" + document.getElementById("inventoryid").value
				 + "&checkid=" + document.getElementById("checkid").value
    			 + "&checkresult=" + document.getElementById("checkresult").value;
		 
			    window.myIframe.location.href = "<%=request.getContextPath()%>/" + actionStr;	
			    document.getElementById("whAreaName").value = ""; //库区
		   		document.getElementById("checkresult").value = ""; //盘点结果
		   		document.getElementById("product").value = "";//产品名   
		   		...
		   		document.getElementById("tonum").value = "";//库存id
...
<body onload="javascript:queryData('<%=id%>');">
 ...
 <table width="98%"  border="0" align="center" cellpadding="0" cellspacing="0" class="table_add">
   ...
   <td width="15%" class="yx1"><input type="hidden" name="wharehouseid" value="<%=wharehouseid%>"><div align="right">库区：</div></td>
     ...
     <td width="15%" class="yx1"><div align="right"><font color="red">*&nbsp;</font>盘点结果：<input type="hidden" name="inventoryid" ></div></td>
     <td width="19%" class="xx1"><div align="left">
	        <input type="hidden" name="inventoryid" size="15" readonly="readonly" class="input_readonly">
	        <input type="hidden" name="checkid" size="15" readonly="readonly" class="input_readonly">
	        <input type="text" name="checkresult" size="15" readonly="readonly" class="input_readonly">
  ...
  <tr>
    ...
    <td class="yx"><div align="left">
     	<input type="text" name="product" readonly="readonly" class="input_readonly">
      </div></td>
    <td class="yx1"><div align="right">生产日期：</div></td>
    <td class="yx"><div align="left">
     	<input type="text" name="printdate" readonly="readonly" class="input_readonly">
      </div></td>
     <td class="yx1"><div align="right">单位：</div></td>
     <td class="xx1"><div align="left"><input type="text" name="unit" readonly="readonly" class="input_readonly"></div></td>
     </tr>
     <tr>
     <td class="yx1"><div align="right">批号类型：</div></td>
     <td class="yx"><div align="left"><input type="text" name="lotid" readonly="readonly" class="input_readonly"></div></td>
     <td class="yx1"><div align="right">批号信息：</div></td>
     <td class="yx"><div align="left"><input type="text" name="lotinfo" readonly="readonly" class="input_readonly"></div></td>
     <td class="yx1"><div align="right">托盘条码：</div></td>
     <td class="xx1"><div align="left">
     	<input type="text" name="traycode" readonly="readonly" class="input_readonly">
      </div></td>
     </tr>
     <tr>
     <td class="yx1"><div align="right">库存数量：</div></td>
     <td class="xx1"><div align="left">
     	<input type="text" name="pnum" readonly="readonly" class="input_readonly">
      </div></td>
     <td class="yx1"><div align="right">目标数量：</div></td>
     <td class="xx1" colspan="3"><div align="left">
     <input type="text" name="tonum" size="17" readonly="readonly" class="input_readonly"></div></td><!-- onblur="sumCubic()" -->
     </tr>
