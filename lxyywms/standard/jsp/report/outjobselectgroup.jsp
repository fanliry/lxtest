...
<body>
  ...
  <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0" class="TABLE_LIST2">
	...
	<tr onmouseover="this.bgColor='#E3F2FF'" onmouseout="this.bgColor=''">
	  <td class="TD_LIST1" align="center"><input type="checkbox" name="check_id" class="input_checkbox" value="customerid"></td>
	  <td class="TD_LIST" align="center"><input type="text" name="newsort" value="<%=5%>" size="2" readonly class="input_readonly"></td>
	  <td class="TD_LIST" align="center"><input type="text" name="names" value="客户" readonly class="input_readonly"></td>
	  <td class="TD_LIST" align="center"><input type="text" name="namecode" value="customerid" readonly class="input_readonly"></td>
	</tr>
	...
	<tr onmouseover="this.bgColor='#E3F2FF'" onmouseout="this.bgColor=''">
	  ...
	  <td class="TD_LIST" align="center"><input type="text" name="newsort" value="<%=8%>" size="2" readonly class="input_readonly"></td>
