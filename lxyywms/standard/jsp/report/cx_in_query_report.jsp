...
<!--
	...
	function openexcel()
	{
		...
		var classname = "com.wms3.bms.standard.action.report.query.CXINQueryExcel";
		
		
		document.tempForm1.action = strUrl + "downFileAction&name=入库流水查询.xls&fileType=excel&classname= " + classname + window.opener.condition;
...
%>
 ...
 <table width="98%" align="center" border="0" cellspacing="0" cellpadding="0">
   <tr>
	 <td height="40" colspan="<%=18 + iLine%>" valign="bottom"><div align="center" class="style2">入&nbsp;存&nbsp;流&nbsp;水&nbsp;查&nbsp;询</div></td>
   </tr>
   <tr>
  	 	...
  	 	for(int i=0; i<ls.size(); i++) 
  	 	{
			ob = (Object[])ls.get(i);
  	 		if(bem != null && bem.length>0){ //分组之后
  	 		    ...
  	 		    pnum = Double.parseDouble(ob[7].toString());			//数量
  	 		    volume = Double.parseDouble(ob[8].toString());		    //体积
  	 		    pweight = Double.parseDouble(ob[9].toString());        	//毛重
  	 		    pnetweight = Double.parseDouble(ob[10].toString());     	//净重
  	 		}
			...
			%>		
					<td class="TD_LIST" align="center"><%=ob[0] == null ? "" : ob[0].toString()%></td>
			         ...
			         <td class="TD_LIST" align="center"><%=ob[2] == null ? "" : ob[2].toString()%></td>
			          ...
			          <td class="TD_LIST" align="center"><%=ob[5] == null ? "" : ob[3].toString()%></td> 
			          
			          <td class="TD_LIST" align="center"><%=ob[6] == null ? "" : ob[4].toString()%></td>
