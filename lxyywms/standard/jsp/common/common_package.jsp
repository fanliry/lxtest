...
<script type="text/javascript">
  <!--
	...
	function queryData()
	{
		...
		condition = "&flag=3" + "&pkgdesc=" + pkgdesc + "&linerow="+linerow;
  ...
  <table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
	<tr><td>
	  ...
	  <table width="98%" align="center" border="0" cellspacing="0" cellpadding="0">
		<tr>
		  <td height="25"><div class="font_001F56_bold_12">当前位置：选择包装</div></td>
		</tr>
	  </table>
    
	  <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0" class="table_add">
	    <tr>
	      <td width="100px" class="yx1" align="right">包装描述：</td>
	      <td class="xx1"><input type="text" name="pkgdesc" size="40" maxlength="50"></td>
	    </tr>  
	    <tr>
	    ...
	    <tr>
	      <td>
	 	    <iframe id="list" name="list" width="100%" height="100%" frameborder="0" scrolling="auto"
				src="<%=request.getContextPath()%>/standard/jsp/common/common_package_list.jsp" ></iframe>
	      </td>
	    </tr> 
 	  </table>
