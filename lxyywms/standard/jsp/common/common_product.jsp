...
<script type="text/javascript">
  <!--
	...
	function queryData()
	{
		...
		var linerow = list.document.getElementById("lineviewrow").value;	//每页显示行数
  ...
  <table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
	<tr><td>
	  ...
	  <table width="98%" align="center" border="0" cellspacing="0" cellpadding="0">
		<tr>
		  <td height="25"><div class="font_001F56_bold_12">当前位置：选择物品</div></td>
		</tr>
	  </table>
    
	  <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0" class="table_add">
	    <tr>
	      <td class="yx1" width="130"><div align="right">产品名称：</div></td>
	      <td class="yx"><input type="text" id="productname" size="20"></td>
	      <td class="yx1" width="130"><div align="right">产品编码：</div></td>
