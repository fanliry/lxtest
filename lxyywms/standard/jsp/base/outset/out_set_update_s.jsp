...
<script type='text/javascript' src="<%=request.getContextPath()%>/dwr/interface/get.js"></script>
<script type='text/javascript' src="<%=request.getContextPath()%>/dwr/interface/select.js"></script>
...
<body onLoad="OnLoad()">
 ...
 <table width="98%" align="center" border="0" cellspacing="0" cellpadding="0">
   <tr>
     <td class="font_006699_bold_12" height="25">当前位置：基本信息 -&gt; 出库设置 -&gt; 修改可用样品类别</td>
   </tr>
 </table>
 ...
 <table width="98%"  border="1" align="center" cellpadding="0" cellspacing="0" class="TABLE_MGR_TOP">
   ...
   <tr>
     <td class="TD_MGR_TOP"><input type="checkbox" name="check_id" value="1" class="input_checkbox"> 成品</td>
     <td class="TD_MGR_TOP"><input type="checkbox" name="check_id" value="2" class="input_checkbox"> 半成品</td>
     <td class="TD_MGR_TOP"></td>
   </tr>
   <tr>
