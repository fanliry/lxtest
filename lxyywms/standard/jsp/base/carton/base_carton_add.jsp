...
<!--
	function OnOk(){
		...
		var back_msg = "&descr=" + descr + "&boxleng=" + boxleng + "&boxwidth=" + boxwidth + "&boxheight=" + boxheight
...
<body>
  ...
  <table width="98%" align="center" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td height="25"><div class="font_001F56_bold_12">当前位置：基本信息 -&gt; 周转箱 -&gt; 新增周转箱信息</div></td>
    </tr>
  </table>
  ...
  <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0" class="table_add">
    <tr>
      ...
      <td class="xx1" colspan="3"><input type="text" id="descr" maxlength="100" size="35"></td>
    </tr> 
    <tr>
      <td class="yx1" align="right">长：</td>
      <td class=yx><input type="text" id="boxleng" maxlength="14" size="14" value="0.0"></td>
      <td width="100px" class="yx1" align="right">最大体积：</td>
      <td class="xx1"><input type="text" id="maxcube" maxlength="14" size="14" value="0.0"></td>
    </tr> 
    <tr>
      <td class="yx1" align="right">宽：</td>
      <td class="yx"><input type="text" id="boxwidth" maxlength="14" size="14" value="0.0"></td>
      <td class="yx1" align="right">最大重量：</td>
      <td class="xx1"><input type="text" id="maxweight" maxlength="14" size="14" value="0.0"></td>
    </tr> 
    <tr>
      <td class="yx1" align="right">高：</td>
      <td class="yx"><input type="text" id="boxheight" maxlength="14" size="14" value="0.0"></td>
      <td class="yx1" align="right">最大数量：</td>
      <td class="xx1"><input type="text" id="maxcount" maxlength="14" size="14" value="0"></td>
    </tr> 
    <tr>
      <td class="yx1" align="right">自重：</td>
      <td class="yx"><input type="text" id="selfweight" maxlength="14" size="14" value="0.0"></td>
      <td class="yx1" align="right">装箱百分比：</td>
      <td class="xx1"><input type="text" id="cartonpercent" maxlength="14" size="14" value="0.0"></td>
    </tr> 
    <tr>
      <td class="yx1" align="right">备注：</td>
      <td class="xx1" colspan="3"><input type="text" id="remark" maxlength="50" size="35"></td>
    </tr>
