...
<!--
	...
	function OnOk(){
		...
		window.returnValue = "&typeid=<%=typeid%>&typename=" + typename + "&typevalue=" + typevalue + 
...
<body>
  ...
  <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0" class="table_add">
    ...
    <tr>
      ...
      <td class="yx"><input type="text" name="selecttext" maxlength="15" size="15" value="<%=selecttext%>"></td>
      <td class="yx1" align="right"><span class="red">*</span>列表值：</td>
      <td class="xx1">
      	<input name="selectvalueHide" type="hidden" value="<%=selectvalue%>"/>
      	<input type="text" name="selectvalue" maxlength="15" size="15" value="<%=selectvalue%>" ></td>
    </tr>
    <tr>
