...
<!--
	...
	function saveData(){
		...
		window.returnValue = "&typeId=" + typeid + "&typeVlaue=" + typevalue + "&typename=" + typename
...
<body>
  ...
  <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0" class="table_add">
    ...
    <tr>
      ...
      <td class="yx"><input type="text" id="selecttext" maxlength="15" onblur="changetText()"></td>
      <td width="100px" class="yx1" align="right"><span class="red">*</span>列表值：</td>
      <td class="xx1"><input type="text" id="selectvalue" maxlength="15" size="15" class="input_readonly" readonly> </td>
    </tr>
    <tr>
