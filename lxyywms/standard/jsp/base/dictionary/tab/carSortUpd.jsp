...
<!--
  function update()
  {
  	...
  	{	
	   ...
	   var actionStr = "rmsService?actionCode=updCarSort" 
...
<form method="post" action="" name="myform">
 <table width="100%"  border="0" cellspacing="0" cellpadding="0">
   <tr>
     <td class="TD_ADD"><div align="left"><input type="hidden" name="id" id="id" value="<%=id%>"></div>
    </td>
 </table>
 ...
 <table width="98%"  border="1" align="center" cellpadding="0" cellspacing="0" class="TABLE_ADD">
   ...
   <tr>
     ...
     <td class="TD_ADD"><div align="left">       <textarea name="remark" id="remark"><%=remark%></textarea>
     </div></td>
     <td class="TD_ADD"></td>
   </tr>
 </table>
