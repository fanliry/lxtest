...
<!--
  function inspect()
  {
  	...
  	if(name!="")
  	{
        ...
        var actionStr = "rmsService?actionCode=addCarSort"
 ...
 <table width="100%"  border="0" cellspacing="0" cellpadding="0">
   <tr>
	 ...
	 <table width="98%"  border="1" align="center" cellpadding="0" cellspacing="0" class="TABLE_ADD">
	   <tr>
	     <td height="25" class="TD_ADD"><div align="right">车型编号：</div></td>
	   ...
	   <tr>
	     <td height="25" class="TD_ADD"><div align="right">车型名称：</div></td>
	   ...
	   <tr>
	     ...
	     <td class="TD_ADD"><div align="left"><textarea name="remark" id="remark"></textarea>
	     </div></td>
	     <td class="TD_ADD"></td>
	   </tr>
	 </table>
