...
<script type="text/javascript">
  ...
  <table width="98%" align="center" border="0" cellspacing="0" cellpadding="0">
   <tr>
     <td height="25"><div class="font_001F56_bold_12">当前位置：出库管理 -&gt; 出库单明细</div></td>
   </tr>
  </table>
	<FORM id="form1">
 ...
 <table width="98%" height="270" border="0" align="center" cellpadding="0" cellspacing="0">
   <tr>
	 <td>
	   <iframe id="list" src="<%=request.getContextPath()%>/BMSService?actionCode=outBoundAction&flag=8&invoiceid=<%=instockid%>" scrolling="auto" frameborder="0" width="100%" height="300px">
	   </iframe>
	 </td>
   </tr>
 </table>
