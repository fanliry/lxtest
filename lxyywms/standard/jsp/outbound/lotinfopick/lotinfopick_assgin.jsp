...
<table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
   ...
   <tr>
     <td><div class="font_001F56_bold_12">当前位置：按批号拣货出库</div></td>
     <td align="right" >
            <input name="button_delete" type="button" class="button_add" id="button_delete" value="&nbsp;&nbsp;分配" onclick="assignData();" />
