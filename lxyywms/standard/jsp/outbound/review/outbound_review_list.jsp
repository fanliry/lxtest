...
<script>
    ...
    function getDetail(strId, obj)
	{
		...
		oldobj = obj;
		var actionStr = "BMSService?actionCode=reviewAction&flag=2&invoiceid=" + strId;
...
<body  id="table_body" onload="javascript:OnLoad();">
 <table width="100%" height="100%"   border="0" align="center" cellpadding="0" cellspacing="0" class="TABLE_LIST">
   <tr>
     ...
     <td  class="TD_LIST_TITLE"><div class="list_title">发货月台</div></td>
     <td  class="TD_LIST_TITLE"><div class="list_title">客户</div></td>
     <td  class="TD_LIST_TITLE2"><div class="list_title">货主</div></td>
   </tr>
<%
	...
	if(ls != null && ls.size() > 0) 
	{
		...
		for(int i = 0; i < ls.size(); i++)
		{
			...
			ownername = outBound.getOwnername();//货主
%>
   <tr onmouseover="this.bgColor='#e1f3ff'" onmouseout="this.bgColor=''" onClick="getDetail('<%=outstockid%>', this)">
     <td class="TD_LIST1" align="center"><input onClick="Change(this)" type="checkbox" name="check_id" class="input_checkbox" value="<%=outstockid%>" alt="<%=customername == null ? "" : customername%>" ><%=i+1%></td>
