...
<!--
	...
	function openexcel()
	{
		...
		var classname = "com.wms3.bms.standard.action.report.outbound.outbound_print_ckcpExcel";
		
		document.tempForm1.action = strUrl + "downFileAction&name=出库产品.xls&fileType=excel&classname= " + classname +"&outstockid="+"<%=instockid%>";
...
<body>
 ...
 %>
   <tr class="list_title_tr">
     ...
     <td class="list_title_td">计划数量</td>
