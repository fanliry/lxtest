...
<body>
  ...
  <table width="100%" height="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="TABLE_LIST">
	<tr>
	  ...
	  <td class="TD_LIST_TITLE" nowrap><div class="list_title">上架规则描述</div></td>
	...
	if(ls != null && ls.size() > 0){
	  	...
	  	for(int i = 0; i < ls.size(); i++){
	  	 	...
	  	 	RulePutaway putaway = (RulePutaway)ls.get(i); 
	  	 	    ...
	  	 	    String putawayid = putaway.getPutawayid(); 	//上架规则ID
	  	 	    String descr = putaway.getDescr();     		//描述
	  	 	    String warehouseid = putaway.getWarehouseid();  //所属仓库ID
  	 	    	String warehousename = putaway.getWarehousename();  //所属仓库名
	  	 		String remark = putaway.getRemark();		// 备注
