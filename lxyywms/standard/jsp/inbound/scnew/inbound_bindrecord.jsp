...
<script type="text/javascript">
	...
	function deleteRecord(){
		...
		list.location.href = "<%=request.getContextPath()%>/BMSService?actionCode=InBoundRequestAction&flag=10&instockid="+instockid+"&bandrecordid="+id;
	}
 </script>
</head>
  <body>
 ...
 <table width="98%" height="270" border="0" align="center" cellpadding="0" cellspacing="0">
   <tr>
	 <td>
	   <iframe id="list" src="<%=request.getContextPath()%>/BMSService?actionCode=InBoundRequestAction&flag=9&instockid=<%=instockid%>" scrolling="auto" frameborder="0" width="100%" height="300px">
	   </iframe>
	 </td>
   </tr>
 </table>
