...
<!--
	...
	function openexcel()
	{
		...
		var classname = "com.wms3.bms.standard.action.report.inbound.inbound_print_cpbdExcel";
		
		document.tempForm1.action = strUrl + "downFileAction&name=产品入库绑定单.xls&fileType=excel&classname= " + classname +"&instockid="+"<%=instockid%>";
...
<body>
 ...
 <table width="98%" align="center" border="0" cellspacing="0" cellpadding="0">
   ...
   <tr>
	 <td height="20" colspan="6" valign="bottom"><div align="center" class="list_title_tdpr">产品入库绑定记录</div></td>
   </tr>
   <tr>
