...
<div style="width:100%; height:100%; overflow-x:scroll; overflow-y:auto; position:absolute;"> 
 <table id="theTable" width="110%" height="100%" border="0" align="center"  cellpadding="0" cellspacing="0" class="TABLE_LIST">
   <thead> 
   <tr>
     <td class="TD_LIST_TITLE1" align="center" width="50px"><div class="list_title">选择</div></td>
     <td class="TD_LIST_TITLE"><div width="30px" class="list_title">行号</div></td>
     <td class="TD_LIST_TITLE"><div width="70px" class="list_title">作业号</div></td>
     <td class="TD_LIST_TITLE"><div width="70px" class="list_title">作业类型</div></td>
     <td class="TD_LIST_TITLE"><div width="100px" class="list_title">品名</div></td>
     <td class="TD_LIST_TITLE"><div width="70px" class="list_title">具体批号</div></td>
     <td class="TD_LIST_TITLE"><div width="100px" class="list_title">生产日期</div></td>
     <td class="TD_LIST_TITLE"><div width="100px" class="list_title">单位</div></td>
	 <td class="TD_LIST_TITLE"><div width="70px" class="list_title">数量</div></td>
     <td class="TD_LIST_TITLE"><div width="100px" class="list_title">仓库</div></td>
     <td class="TD_LIST_TITLE"><div width="100px" class="list_title">巷道</div></td>
     <td class="TD_LIST_TITLE"><div width="100px" class="list_title">货位</div></td>
     <td class="TD_LIST_TITLE"><div width="70px" class="list_title">托盘条码</div></td>
     <td class="TD_LIST_TITLE"><div width="100px" class="list_title">输送机号</div></td>
     <td class="TD_LIST_TITLE"><div width="120px" class="list_title">生成时间</div></td>
     <td class="TD_LIST_TITLE"><div width="120px" class="list_title">完成时间</div></td>
   </tr>
   </thead>  
   <tbody> 
<%
