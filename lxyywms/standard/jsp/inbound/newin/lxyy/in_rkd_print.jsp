...
<!--
	...
	function openexcel()
	{
		...
		var classname = "com.wms3.bms.standard.action.report.inbound.inbound_print_rkdExcel";
		
		document.tempForm1.action = strUrl + "downFileAction&name=产品入库单.xls&fileType=excel&classname= " + classname +"&instockid="+"<%=instockid%>";
...
<body onLoad="OnLoad()">
 ...
 <table width="98%" align="center" border="0" cellspacing="0" cellpadding="0">
   ...
   <tr>
	 <td height="20" colspan="6" valign="bottom"><div align="center" class="list_title_tdpr">产品入库单</div></td>
   </tr>
   <tr>
   ...
   <tr>
	 <td height="20"><div align="left"  class="list_title_tdpr">交货单位：<%=deliveryunits==null?"":deliveryunits%></div></td>
 ...
 <table width="98%" border="1" align="center" cellpadding="0" cellspacing="0" class="outer_table">
   <tr>
     ...
     <td class="list_title_td" align="center">托盘号</td>
...
<%
 ...
 %>
		     ...
		     <td class="list_normal_td" align="center"></td> <!-- <%//=getnum%> -->
