...
<table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
   <tr>
     <td>
	     ...
	     <div class="wz" >
	      <div id="dqwz" class="f_l">当前位置：<span>入库管理</span> &gt;&gt; <span>上架</span></div>
	      <div  class="f_r" id="caozuo">
	        <ul>
	          <li class="tubiao2" style="width:80px;"><a href="#" onclick="cancelputaway();">取消上架</a></li>
	          <li class="tubiao2" style="width:100px;"><a href="#" onclick="printLabel();">打印收货标签</a></li>
	          <li class="tubiao2" style="width:80px;"><a href="#" onclick="executePutaway();">执行上架</a></li>
	          <li class="tubiao2" style="width:100px;"><a href="#" onclick="printTask();">打印上架任务</a></li>
	          <li class="tubiao2" style="width:90px;"><a href="#" onclick="addPutaway();">按单据上架</a></li>
	          <li class="tubiao2"><a href="#" onclick="codeTray();">码盘</a></li>
