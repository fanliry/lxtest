...
<div style="width:100%; height:100%; overflow-x:scroll; overflow-y:auto; position:absolute;">
 <table width="150%" height="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="TABLE_LIST">
   <tr>
     ...
     <td class="TD_LIST_TITLE" align="center"><div class="list_title">收货单号</div></td>
...
<%
	List ls = (List)request.getAttribute("tasks");
 ...
 %>
		     ...
		     <td class="TD_LIST" align="center"><%=inreceiptid%></td>
...
%>
   ...
   <tr>
      <td height="100%" colspan="<%=13 + iLine%>" valign="top" class="TD_last_LIST">
