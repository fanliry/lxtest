...
<script type="text/javascript">
	...
	function deleteRecord(){
		...
		judgmentTool.isCancelReceive(id, Show);
		...
		list.location.href = "<%=request.getContextPath()%>/BMSService?actionCode=OtherInBoundAction&flag=8&instockid="+instockid+"&receiverecordid="+id;
	}
 </script>
</head>
  <body>
 ...
 <table width="98%" height="270" border="0" align="center" cellpadding="0" cellspacing="0">
   <tr>
	 <td>
	   <iframe id="list" src="<%=request.getContextPath()%>/BMSService?actionCode=OtherInBoundAction&flag=7&instockid=<%=instockid%>" scrolling="auto" frameborder="0" width="100%" height="300px">
	   </iframe>
	 </td>
   </tr>
 </table>
