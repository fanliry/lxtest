...
var ac = "<%=request.getContextPath()%>/BMSService?actionCode=";
	...
	function queryDetail(id){
		...
		parent.tableheight2.location.href = ac + "OtherInBoundAction&flag=3&instockid=" + id;
	}
	...
	{
		oldobj = obj;
		var actionStr = "BMSService?actionCode=OtherInBoundAction&flag=3&instockid=" + strId;
...
<body  id="table_body" onload="javascript:OnLoad();">
 <table width="100%" height="100%" id="theTable"   border="0" align="center" cellpadding="0" cellspacing="0" class="TABLE_LIST">
   <tr>
     ...
     <td width="80" class="TD_LIST_TITLE"><div class="list_title">入库单号</div></td>
     ...
     <td width="80" class="TD_LIST_TITLE"><div class="list_title">确认时间</div></td>
     <td width="80" class="TD_LIST_TITLE"><div class="list_title">备注</div></td>
     <td width="80" class="TD_LIST_TITLE"><div class="list_title">收货记录</div></td>
...
<%
	...
	if(ls != null && ls.size() > 0) 
	{
		...
		String instockid;      //入库单号
        String invoicetypename;    //单据类型
        String inrequeststockid;      //入库申请单号
...
%>
   <tr onmouseover="this.bgColor='#e1f3ff'" onmouseout="this.bgColor=''" onClick="setSel(<%=i%>);">
     ...
     <td class="TD_LIST" align="center"><input type="button" name="diaplayRecord" value="显示" onclick="disaplayReceive('<%=instockid%>')"  style="width:80px;"/></td>
   </tr>
<%			
		}
	}
