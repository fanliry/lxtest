...
<script type="text/javascript">
	...
	function saveData()
	{
	    ...
	    if(confirm("你确定修改吗？"))
		{
	    	window.returnValue = "InjobSafeguardAction&method=ricoExecEditJob&flag=pc"+ condition;
	    	window.close();
		}
	...
	function getInfo()
	{
		...
		window.location.href = strUrl + "InjobSafeguardAction&flag=1&traycode=" + traycode;
	}
...
<body onload="onLoad();">
	<table id="tbb" border="1" align="center" cellpadding="0" cellspacing="0" class="TABLE_MGR_TOP">
			...
			<td height="25" bgcolor="#d9e8fc" align="center" colspan="2">
				<table width="100%">
    				<tr><td>
					  ...
					  <!-- ======== 当前位置 ======== -->
					  <div class="wz">
						<div id="dqwz" class="f_l">当前位置：<span>入库管理 &gt;&gt; 作业管理 &gt;&gt; 入库维护</span></div>
					  </div>
		...
		<tr>
			...
			<input type="text" name="traycode" class="rf_input_long" maxlength="10" value="<%=traycode == null ? "":traycode %>" disabled> <font color="red">*</font></td>
		</tr>
		<tr>
