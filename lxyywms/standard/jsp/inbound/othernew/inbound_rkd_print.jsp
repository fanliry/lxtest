...
<!--
	...
	function openexcel()
	{
		...
		document.tempForm1.action = strUrl + "downFileAction&name=其他入库申请单.xls&fileType=excel&classname= " + classname +"&instockid="+"<%=instockid%>";
...
<body onLoad="OnLoad()">
 ...
 <table width="98%" align="center" border="0" cellspacing="0" cellpadding="0">
   ...
   <tr>
	 <td height="20" colspan="6" valign="bottom"><div align="center" class="list_title_tdpr">其他入库申请</div></td>
   </tr>
   <tr>
...
%>	
 ...
 <table width="98%" align="center" border="0" cellspacing="0" cellpadding="0">
   ...
   <tr>
	 ...
	 <td height="20" width="250"><div align="left"  class="list_title_tdpr"></div></td>
	 <td height="20"><div align="left"  class="list_title_tdpr">经手人：</div></td>
	 <td height="20"><div align="left"  class="list_title_tdpr">经手日期：</div></td>
   </tr>
