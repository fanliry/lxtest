...
<script>
	function Change(obj,instockid,instockdetailid)
	{
...
<%
 ...
 %>
	         <tr class="list_normal_tr" onmouseover="this.style.backgroundColor='#CCFF00'" onmouseout="this.style.backgroundColor=''" onclick="Change(this,<%=instockdetailid%>,instockid)">
