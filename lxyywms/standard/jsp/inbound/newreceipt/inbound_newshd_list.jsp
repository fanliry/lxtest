...
<script>
    ...
    function getDetail(strId, obj)
	{
		...
		oldobj = obj;
		var actionStr = "BMSService?actionCode=inBoundREAction&flag=3&invoiceid=" + strId;
...
<body  id="table_body" onload="javascript:OnLoad();">
 <table width="100%" height="100%"   border="0" align="center" cellpadding="0" cellspacing="0" class="TABLE_LIST">
   <tr>
     ...
     <td width="100" class="TD_LIST_TITLE"><div class="list_title">单据号</div></td>
     <td width="100" class="TD_LIST_TITLE"><div class="list_title">单据状态</div></td>
     <td width="100" class="TD_LIST_TITLE"><div class="list_title">产品批号</div></td>
     <td width="100" class="TD_LIST_TITLE2"><div class="list_title">产品编码</div></td>
     <td width="120" class="TD_LIST_TITLE"><div class="list_title">产品名称</div></td>
     <td width="120" class="TD_LIST_TITLE"><div class="list_title">产品规格</div></td>
     <td width="120" class="TD_LIST_TITLE"><div class="list_title">包装规格</div></td>
     <td width="80" class="TD_LIST_TITLE"><div class="list_title">建单人</div></td>
     <td width="80" class="TD_LIST_TITLE"><div class="list_title">建单日期</div></td>
