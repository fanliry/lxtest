...
<table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
   <tr>
     <td>
	     <div class="wz" >
	      <div id="dqwz" class="f_l">当前位置：<span>入库管理</span> &gt;&gt; <span>入库申请单管理</span></div>
	      <div  class="f_r" id="caozuo">
	        <ul>
	          <li class="tubiao1"><a href="#" onclick="queryinvoice();">查询</a></li>
	          <li class="tubiao2"><a href="#" onclick="updateinvoice();">修改</a></li>
	          <li class="tubiao3" style="width:100px"><a href="#" onclick="deleteData();">取消入库申请</a></li>
	          <!--  <li class="tubiao2"><a href="#" onclick="addinvoicedetail();">明细</a></li>-->
	          <li class="tubiao4" style="width:90px"><a href="#" onclick="addinvoice();">新建申请单</a></li>
	        </ul>
	      </div>
	    </div>
   ...
   <tr>
     <td height="5"></td>
		...
		<table id="querycondition" width="99%"  border="0" align="center" cellpadding="0" cellspacing="0" class="table1">
              <tr>
                <td width="80" class="y1" align="right"><div align="right">单据状态：</div></td>
                ...
                <td class="y1" width="60"><div align="right">申请单号：</div></td>
                <td class="x"  width="">
         ...
         <!--    <tr>
             	<td width="80"  class="y1"><div align="right">仓&nbsp;&nbsp;&nbsp;&nbsp;库：</div></td>
                <td width="150" class="x"><div align="left">
                  <select id="warehouseid" style="width:100px;">
                    <option value="">--请选择--</option>
                  </select></div>
                </td>
                <td width="60" class="y1"><div align="right">货&nbsp;&nbsp;&nbsp;&nbsp;主：</div></td>
