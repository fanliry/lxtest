...
<script>
    ...
    function getDetail(strId, obj)
	{
		...
		oldobj = obj;
		var actionStr = "BMSService?actionCode=inBoundREAction&flag=re3&invoiceid=" + strId;
...
<body  id="table_body" onload="javascript:OnLoad();">
 <table width="100%" height="100%"   border="0" align="center" cellpadding="0" cellspacing="0" class="TABLE_LIST">
   <tr>
     ...
     <td width="80" class="TD_LIST_TITLE"><div class="list_title">单据状态</div></td>
     <td width="80" class="TD_LIST_TITLE"><div class="list_title">单据类型</div></td>
     <td width="120" class="TD_LIST_TITLE"><div class="list_title">货主</div></td>
     <td width="80" class="TD_LIST_TITLE"><div class="list_title">创建人</div></td>
     <td width="80" class="TD_LIST_TITLE"><div class="list_title">创建时间</div></td>
     <td width="120" class="TD_LIST_TITLE"><div class="list_title">供应商</div></td>
     <td width="120" class="TD_LIST_TITLE"><div class="list_title">承运人</div></td>
     <td width="" class="TD_LIST_TITLE2"><div class="list_title">海关备案号</div></td>
   </tr>
<%
