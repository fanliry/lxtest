...
/* 		//验证输送机号
	    ...
	    if(confirm("你确定收货吗？"))
		{		
			window.location.href = strUrl + "inBoundJobAction&method=ricoExecCreateRFJob&rfmainView=rfmainView&flag=qtrk"+ condition;
		}
		...
		<tr>
			<td height="25" bgcolor="#d9e8fc" align="center" colspan="2">
				<table width="100%">
					<tr>
						<td width="20%"></td>
						<td width="60%" align="center" class="font_006699_bold_12">RF其它入库</td>
