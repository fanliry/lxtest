...
/* 		//验证输送机号
	    ...
	    if(confirm("你确定收货吗？"))
		{		
			window.location.href = strUrl + "inBoundJobAction&method=ricoExecCreateRFJob&rfmainView=rfmainView&flag=xtrk"+ condition;
		}
	...
	function onLoad()
	{
		...
		selectType('13', 'intype', 'rklx');			//入库类型
		...
		<tr>
			<td height="25" bgcolor="#d9e8fc" align="center" colspan="2">
				<table width="100%">
					<tr>
						<td width="20%"></td>
						<td width="60%" align="center" class="font_006699_bold_12">RF销退入库</td>
