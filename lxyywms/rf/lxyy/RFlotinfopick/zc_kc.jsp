...
<html>
 ...
 <script>
	...
	{ 
  	...
  	function OnLoad()
	{	
		list.location.href = strUrl + "outBoundAction&flag=lotinfopickzc&isRF=rf&detailid=<%=detailid%>&Virtualwhid=<%=Virtualwhid%>&productid=<%=productid%>&lotinfo=<%=lotinfo%>";
	}
 </script>
</head>
...
<table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
   ...
   <tr>
     <td class="TD_LIST_TITLE"><div class="list_title">RF按批号拣货出库 -&gt; 暂存列表</div></td>
   </tr>
   		<tr>
			<td class="TD_ADD" align="center" colspan="2">
			<input type="button" name="add" class="BUTTON_STYLE1" value="确认" onClick="assignData();">
			<input type="button" name="add" class="BUTTON_STYLE1" value="关闭" onClick="window.close();">
			</td>
		</tr>
  </table>
</td>
 ...
 <table width="98%" height="100%" border="0" align="center" cellpadding="0" cellspacing="0">
   <tr>
	 <td>
		 <iframe id="list" src="<%=request.getContextPath()%>/rf/lxyy/RFlotinfopick/zc_kc_list.jsp" scrolling="auto" frameborder="0" width="100%" height="100%">  
	  		 </iframe>
	 </td>
   </tr>
 </table>
