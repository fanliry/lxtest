...
<script>
	...
	function queryDetail(id){
		...
		parent.detail.location.href = ac + "inBoundPoAction&flag=7&RFflag=rf&poid=" + id;
	}
...
<body onLoad="OnLoad()">
 <table width="100%" height="100%"   border="0" align="center" cellpadding="0" cellspacing="0" class="TABLE_LIST">
   <tr>
	    <td width="50" class="TD_LIST_TITLE1" width="25px"><div class="list_title">行号</div></td>
...
%>
   <tr onmouseover="this.bgColor='#e1f3ff'" onmouseout="this.bgColor=''" onclick="setSel(<%=i%>)">
     <td class="TD_LIST1" align="center">
     	<input onclick="setSel(<%=i%>)" type="radio" name="check_id" class="input_checkbox" value="<%=poid%>"><%=i+1%></td>
...
%>
	...
	<tr>
      <td height="100%" colspan="3" valign="top" class="TD_last_LIST">
