...
<script language='JavaScript' charset='gb2312'> 
	...
	function userLogin()
	{
		...
		name1 = "newwindow"+(new Date().getTime().toString(36));
		...
		--%>
		<%--
		window.open(document.formx1.submit(), "newwindow"+(new Date().getTime().toString(36)), 
						"fullscreen=yes, toolbar=no, menubar=no, scrollbars=no, resizable=yes, location=no, status=no");
...
<div style="margin-top:2px;" > <input id="username" type="text"  class="input_st"/></div>
<div style="margin-top:10px;"> <input id="password" type="password"  class="input_st"  /></div>
</div>
...
<p> 联系电话：0571-89988562 </p>
<p> 地址：杭州市文三路478号华星时代广场A座601室 </p>
<p><%= StrTools.getCurrDateTime(8)%> </p>
</div>
</div>
</body>
</html>